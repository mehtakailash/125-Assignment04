...
class ClientAccountTest {
	...
	void testCompare() {
        ...
        ClientAccount   client  = new ClientAccount( name, contact, addr );
		assertNotNull(clientAccount.compare(clientAccount, client));
		assertThrows(NullPointerException.class, ()-> clientAccount.compare(null, null ));
		assertThrows(NullPointerException.class, ()-> clientAccount.compare(null, client ));
		assertThrows(NullPointerException.class, ()-> clientAccount.compare(clientAccount, null ));
	}
