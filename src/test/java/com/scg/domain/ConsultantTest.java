...
//		PersonalName pName = new PersonalName(firstName,lastName,middleName);
	...
	void testCompare() {
		...
		assertNotNull(Consultant.compare(Consultant, Consultant1));
		assertThrows(NullPointerException.class, ()-> Consultant.compare(null, null ));
		assertThrows(NullPointerException.class, ()-> Consultant.compare(null, Consultant1 ));
		assertThrows(NullPointerException.class, ()-> Consultant.compare(Consultant, null ));
	}
