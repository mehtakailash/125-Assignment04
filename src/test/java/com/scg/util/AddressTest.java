...
//		Address addr    = new Address( STREET, CITY, STATE, ZIP );
	...
	void testCompare() {
		Address addr1   = new Address( STREET, CITY, STATE, ZIP );
		assertNotNull(address.compare(address, addr1));
		assertThrows(NullPointerException.class, ()-> address.compare(null, null ));
		assertThrows(NullPointerException.class, ()-> address.compare(null, addr1 ));
		assertThrows(NullPointerException.class, ()-> address.compare(address, null ));
	}
